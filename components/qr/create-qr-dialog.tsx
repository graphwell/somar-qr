  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (res.error) {
        ...
        setOpen(false)
        setForm({ name: "", targetUrl: "", description: "", color: "#000000", bgColor: "#FFFFFF", slug: "" })
      }
    } finally {
      setLoading(false)
    }
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {BG_PRESETS.map((p) => (
                  ...
                  >
                    <span
                      ...
                      style={{ background: p.bg === "#00000000" ? "repeating-conic-gradient(#ccc 0% 25%, #fff 0% 50%) 0 0 / 6px 6px" : p.bg }}
                    />
                    {p.label}
                  </button>
                ))}
            ...
            <div className="flex items-center gap-3 rounded-lg border p-3 bg-gray-50">
              <div
                ...
                style={{ background: form.bgColor === "#00000000" ? "repeating-conic-gradient(#ccc 0% 25%, #fff 0% 50%) 0 0 / 6px 6px" : form.bgColor }}
              >
